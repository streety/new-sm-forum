...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000079c857f00000000000a90fe9(
...
class phpbbtemplatetwiglexer_0000000079c857f00000000000a90fe9 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b0b26404a87d254188151 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b0b26404a884320955119 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b0b26404a85f253946133 = array(
    ...
    {
        $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, 'set_environment', array('env' => $env), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;

        return $this->valueHolder5b0b26404a87d254188151->set_environment($env);
    }
    ...
    {
        $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;

        return $this->valueHolder5b0b26404a87d254188151->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;

        return $this->valueHolder5b0b26404a87d254188151->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b0b26404a884320955119 = $initializer;
    }
    ...
    {
        $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, '__get', array('name' => $name), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;

        if (isset(self::$publicProperties5b0b26404a85f253946133[$name])) {
            return $this->valueHolder5b0b26404a87d254188151->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b0b26404a87d254188151;
    ...
    {
        $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;
    ...
    {
        $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, '__isset', array('name' => $name), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;
    ...
    {
        $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, '__unset', array('name' => $name), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;
    ...
    {
        $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, '__clone', array(), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;

        $this->valueHolder5b0b26404a87d254188151 = clone $this->valueHolder5b0b26404a87d254188151;
    }

    public function __sleep()
    {
        $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, '__sleep', array(), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;

        return array('valueHolder5b0b26404a87d254188151');
    }
    ...
    {
        return $this->initializer5b0b26404a884320955119;
    }
    ...
    {
        return $this->initializer5b0b26404a884320955119 && ($this->initializer5b0b26404a884320955119->__invoke($valueHolder5b0b26404a87d254188151, $this, 'initializeProxy', array(), $this->initializer5b0b26404a884320955119) || 1) && $this->valueHolder5b0b26404a87d254188151 = $valueHolder5b0b26404a87d254188151;
    }
    ...
    {
        return null !== $this->valueHolder5b0b26404a87d254188151;
    }
    ...
    {
        return $this->valueHolder5b0b26404a87d254188151;
    }
